...
m["awd-war"] = {
	aliases = {"Warekena", "Guarequena", "Warekena Velha", "Warekena do San Miguel"}, -- Warekena of San Miguel; distinguish from gae
}
...
m["grk-car"] = {
	aliases = {"Cargese Greek", "Greco-Corsican"}, -- some sources appear to use Greco-Corsican for something else
}
...
m["sai-krp"] = { -- distinguish from Kawahiva (Tupian) Karipuna
	aliases = {"Caripuná", "Caripuna", "Jau-Navo", "Jaũn Àvo"}, -- reportedly also E'loê, Éloe, Shakáre, Yacaría but these seem unattested
}
...
m["sai-ptx"] = {
	aliases = {"Southern Pataxó", "Pataxo", "Patashó", "Patachó"},
}
...
m["tup-kaw"] = {
	aliases = {"Kawahíva", "Kawahiba", "Kawahíb", "Kawahib", "Kagwahíb", "Kagwahib"},
	varieties = {{"Parintintín", "Parintintin"}, {"Tenharim", "Tenharin"}, {"Júma", "Juma"}, {"Uru-Eu-Wau-Wau", "Jupaú", "Jupau"}, {"Amondawa", "Amundava"}, {"Karipuná", "Karipuna"}}, 
}
